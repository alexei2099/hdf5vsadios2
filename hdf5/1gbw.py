...
def generate_dataset(size_mb=1024):  # 1GB = 1024MB
...
def write_hdf5(dataset, filename='dataset_1gb.h5'):
...
def read_hdf5(filename='dataset_1gb.h5'):
    start_time = time.time()
...
if __name__ == "__main__":
    dataset = generate_dataset(1024)  # Generate 1 GB dataset
