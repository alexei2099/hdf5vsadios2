...
def generate_dataset(size_mb=10240):  # 10GB = 10240MB
...
def write_hdf5(dataset, filename='dataset_10gb.h5'):
...
def read_hdf5(filename='dataset_10gb.h5'):
    start_time = time.time()
...
if __name__ == "__main__":
    dataset = generate_dataset(10240)  # Generate 10 GB dataset
