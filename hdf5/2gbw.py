...
def generate_dataset(size_mb=2048):  # 2GB = 2048MB
...
def write_hdf5(dataset, filename='dataset_2gb.h5'):
...
def read_hdf5(filename='dataset_2gb.h5'):
    start_time = time.time()
...
if __name__ == "__main__":
    dataset = generate_dataset(2048)  # Generate 2 GB dataset
