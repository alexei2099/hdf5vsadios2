...
def generate_dataset(size_mb=300):
...
def write_hdf5(dataset, filename='dataset_300mb.h5'):
...
def read_hdf5(filename='dataset_300mb.h5'):
    start_time = time.time()
...
if __name__ == "__main__":
    dataset = generate_dataset(300)  # Generate 300 MB dataset
