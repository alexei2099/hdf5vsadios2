...
def generate_dataset(size_mb=3072):  # 3GB = 3072MB
...
def write_hdf5(dataset, filename='dataset_3gb.h5'):
...
def read_hdf5(filename='dataset_3gb.h5'):
    start_time = time.time()
...
if __name__ == "__main__":
    dataset = generate_dataset(3072)  # Generate 3 GB dataset
