...
def generate_dataset(size_mb=5120):  # 5GB = 5120MB
...
def write_hdf5(dataset, filename='dataset_5gb.h5'):
...
def read_hdf5(filename='dataset_5gb.h5'):
    start_time = time.time()
...
if __name__ == "__main__":
    dataset = generate_dataset(5120)  # Generate 5 GB dataset
